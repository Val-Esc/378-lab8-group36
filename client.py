...
while success == 'n':
  try:
    ...
    serverPort = int(input("Enter server port number: "))  # prompt user for server port number
...
while continue_Client == 'y':
  ...
  print("Result of your query: ", serverResponse) #display server capital message response
